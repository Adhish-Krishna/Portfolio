  ...
  projects = [
    {
      ...
      description: "A modern portfolio built with React and TailwindCSS featuring interactive animations and responsive design.",
    ...
    },
    {
      ...
      description: "A productivity application for managing tasks with real-time updates and collaboration features.",
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="h-full flex flex-col">
                ...
                <p className="text-neutral-400 text-sm flex-grow mb-4">{project.description}</p>
