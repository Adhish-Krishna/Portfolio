...
interface ContactProps {
  ...
  subtitle?: string;
  email?: string;
  socials?: { name: string; url: string; icon: React.ReactNode }[];
  accentColor?: string;
}
    ...
    >
      <div className="container mx-auto px-4 relative z-10 py-20">
        ...
        <div className="max-w-4xl mx-auto flex justify-center items-center">
          ...
          <div className="bg-[#0a1622] border border-[#171717] rounded-xl p-6 transition-all duration-300 hover:border-opacity-50 w-[400px]"
            ...
            <div className="space-y-6">
              ...
              <div>
                <p className="text-neutral-300 text-sm">Follow Me</p>
